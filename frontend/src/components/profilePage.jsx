...
const ProfilePage = () => {
    ...
    return (
        <>
            <div className="flex sm:my-0 md:h-[550px] overflow-hidden bg-gray-400 bg-clip-padding backdrop-filter backdrop-blur-lg bg-opacity-0">
                {!isMobile && (
                    <div className="w-[300px] h-full">
                        <Sidebar />
                    </div>
                )}
                <div className="flex flex-col flex-1 sm:w-full md:min-w-[550px] h-full px-4 py-6 mt-0 text-white" onClick={(e) => playStatusHandler(e, authUser)}>
